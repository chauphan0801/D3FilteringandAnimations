...
function start() {
    ...
    d3.select(graph)
        ...
        .on('click', function() {
            bars.selectAll('.bar')
                .filter(function(d) {
                   var inputFrequency = document.getElementById("userInput").value;
                   return d.frequency >= inputFrequency;
                })
                .transition()
                .duration(function(d) {
                ...
                .style('fill', function(d) {
                    var e = document.getElementById("barColor");
